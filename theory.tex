...
have a value of $\sim1~\tev$, the hierarchy problem is resolved.
...
the existence of a unification of particle physics with \GR at high
energy scales. The existence of \SUSY is a prerequisite for
string theory, for example, a favourite unification candidate.
...
present itself at the TeV energy scale, which is just
