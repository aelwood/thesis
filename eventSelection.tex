...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{figs/analysis/eventSelection/mht40_pt_Div_metNoX_pt_all_all_80X_noOverflow_scaled0p6}%alphaT1_bkgd}
	\end{center}
...
algorithms, as detailed in Sec.~\ref{sec:muons_reco}. The
...
Sec.~\ref{sec:evSel_jets} that are subject to the kinematic requirements of
$pT>40$~\gev and $|\eta|<3$.
