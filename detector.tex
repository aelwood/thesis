...
\begin{figure}
  ...
  accelerate hadrons to high energies within the \LHC
  \cite{stfc:lhc}}%
  \label{fig:lhc}
\end{figure}
...
magnitude of this current is proportional to the energy deposited
...
designed to absorb hadrons that have punched through the \ECAL.
...
The \HCAL's brass absorbers are arranged in plates that are interspersed with
...
lengths. Beyond the magnetic coil is the \ac{HO} that increases the
interaction length in line with the \ac{HB} to a minimum of $11.8$ .
The magnetic coil acts as an additional absorber for the scintillators in the
...
losing little energy via brehmsstrahlung. They therefore mostly pass
...
greater than $1\%$ precision \cite{CMS:1997dma}.
...
it can only be stored in the read-out pipelines a total of $3.2~\mu$s,
...
computing farm \cite{Cittolin:578006}.  With reduced event rate
