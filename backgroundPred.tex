...
crossing in \MC simulation before and after \PU reweighting, compared
to the distribution measured in data.} \label{f044_corr_nTrueInt_data_mc_norm}
\end{figure}
...
scale factors are typically small, at most a few percent \cite{CMS-DP-2017-007,CMS-DP-2016-042}.
...
systematics and free floating parameters, with $\htcat\equiv J$, can be written as:
\small
\begin{multline}
\label{eq:hadronicLikelihood}
