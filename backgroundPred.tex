...
The data used by this version of the analysis comprises
$12.9\pm0.8~\ifb$ of proton-proton collisions produced by the \LHC and
recorded by \CMS during the first few months of 2016. The data for
this analysis are collected with the triggers described in
Sec.~\ref{sec:trigStrat}.
...
region, their are some inefficiencies at low values of \HT and \MHT.
...
simulation is continuous as a function of the \HT or \nj. The fact
...
the appendix, Sec.~\ref{sec:mhtBinning}.
...
control regions, the effect of jet energy scale on the transfer factor
...
plots show the change in transfer factors for the \mj,\mmj and \gj control
