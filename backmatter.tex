...
\acro{PU}{pileup}
\acro{OOTPU}{out of time pileup}
\acro{PUS}{pileup subtraction}
...
\acro{DA}{\emph{deterministic annealing}}
...
\acro{CHF}{charged hadron fraction}
\acro{SIT}{single isolated track}
...
\acro{CSVv2}{Combined Secondary Vertex version 2}
...
\acro{SMS}{simplified model spectra}
