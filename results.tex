...
\begin{figure}[h!]
  \begin{center}
    \subfloat[T2tt: Upper limit on the cross section in the $(m_{\mathrm{Gluino}},m_{\mathrm{Susy}})$ plane]{
      \includegraphics[width=0.6\textwidth]{figs/analysis/interpretation/T2ttXSEC}
      \label{fig:T2tt_excl}
    } \\
...
\begin{figure}[h!]
  \begin{center}
    \subfloat[T2bb: Upper limit on the cross section in the $(m_{\mathrm{Gluino}},m_{\mathrm{Susy}})$ plane]{
      \includegraphics[width=0.6\textwidth]{figs/analysis/interpretation/T2bbXSEC}
      \label{fig:T2bb_excl}
    } \\
...
\begin{figure}[h!]
  \begin{center}
    \subfloat[T2qq: Upper limit on the cross section in the $(m_{\mathrm{Gluino}},m_{\mathrm{Susy}})$ plane]{
      \includegraphics[width=0.6\textwidth]{figs/analysis/interpretation/T2qqXSEC}
      \label{fig:T2qq_excl}
    } \\
...
\begin{figure}[h!]
  \begin{center}
    \subfloat[T1tttt: Upper limit on the cross section in the $(m_{\mathrm{Gluino}},m_{\mathrm{Susy}})$ plane]{
      \includegraphics[width=0.6\textwidth]{figs/analysis/interpretation/T1ttttXSEC}
...
\begin{figure}[h!]
  \begin{center}
    \subfloat[T1bbbb: Upper limit on the cross section in the $(m_{\mathrm{Gluino}},m_{\mathrm{Susy}})$ plane]{
      \includegraphics[width=0.6\textwidth]{figs/analysis/interpretation/T1bbbbXSEC}
...
\begin{figure}[h!]
  \begin{center}
    \subfloat[T1qqqq: Upper limit on the cross section in the $(m_{\mathrm{Gluino}},m_{\mathrm{Susy}})$ plane]{
      \includegraphics[width=0.6\textwidth]{figs/analysis/interpretation/T1qqqqXSEC}
